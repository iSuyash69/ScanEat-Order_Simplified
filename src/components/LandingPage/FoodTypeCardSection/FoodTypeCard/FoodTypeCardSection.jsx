...
const FoodTypeCard=()=>{
    ...
    return(
        <div className="food-type-card">
            <Link to={"/subCategory/chinesse"}><img src={link+"PC_Creative%20refresh/3D_bau/banners_new/Chinese.png"} alt="img1"/></Link>
            ...
            <Link to={"/subCategory/Dessert"}><img src={link+"PC_Creative%20refresh/Desserts_2.png"} alt="img8"/></Link>
        </div>
    );
}
